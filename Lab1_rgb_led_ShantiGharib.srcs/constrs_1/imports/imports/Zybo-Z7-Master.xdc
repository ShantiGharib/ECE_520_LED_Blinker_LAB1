...
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { X_NIBBLE_INPUT[3] }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
...
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { X_NIBBLE_OUTPUT[1] }]; #IO_L23N_T3_35 Sch=led[1]
#set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { X_NIBBLE_OUTPUT[2] }]; #IO_0_35 Sch=led[2]
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { X_NIBBLE_OUTPUT[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
...
#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports { XSEVEN_SEGMENTS[0] }]; #IO_L8P_T1_34 Sch=jc_p[3] pin 7              
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { XSEVEN_SEGMENTS[1] }]; #IO_L8N_T1_34 Sch=jc_n[3] pin 8              
#set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33     } [get_ports { XSEVEN_SEGMENTS[2] }]; #IO_L2P_T0_34 Sch=jc_p[4] pin 9              
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33     } [get_ports { XSEVEN_SEGMENTS[3] }]; #IO_L2N_T0_34 Sch=jc_n[4] pin 10             
...
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33     } [get_ports { XSEVEN_SEGMENTS[4] }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3] pin 7           
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33     } [get_ports { XSEVEN_SEGMENTS[5] }]; #IO_L11N_T1_SRCC_34 Sch=jd_n[3] pin 8           
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33     } [get_ports { XSEVEN_SEGMENTS[6] }]; #IO_L21P_T3_DQS_34 Sch=jd_p[4]  pin 9            
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33     } [get_ports { XSEVEN_SEGMENTS[7] }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4]  pin 10       
